...
**2026-09-22 早上，`fix/d7-interview-figma`（PR #37，待合入）**：`/interview` 網頁錄音畫面更貼近 Figma frame 10:83：面試中不顯示標頭、版面滿版，標籤只寫 Current Question，拿掉圓球上的 READY 字樣和卡片底部提示；兩顆圓鈕改成 Figma 的 ▶／■（▶ 開始錄音、■ 停止），點圓球重播題目。電話面試與開始畫面未動。verify GREEN。
